...
% LastEditTime : 2021-03-11 22:45:52
...
function [lon_f,lat_f,cc_global,headLineTxt,figurePath,colorLab] = Pyn_figure4(exmNum, mdlNum)
    ...
    for esmNum = specificNum:specificNum%1:length(esmName)
        ...
        load([dradEffectPath, 'real_dradEffect.mat'])% 'dR_allsky', 'l_rad', 's_rad', 'dR_clr', 'readme_realradEffect'
    ...
    headLineTxt = ['The correlation coefficient of dRTs and dRHeating, Level:', toaSfc{2}, '~C~            Era: ', level.time1{exmNum}(5:end - 1), ', Model:', level.model2{mdlNum}, '~C~            Ensemble: ', esmName{esmNum},', global mean CC= ', num2str(cc_weightMean{2})];
