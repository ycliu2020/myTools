...
% Description  :
% FilePath     : /code/home/liuyc/lib/tools/matlab/myTools/a_rschingFun/cmip/amipAndERA5CC_glbTS.m
%
%%---------------------------------------------------------
function [lon_f, lat_f, cc_glbSet, figTitle, figPath, colorLab] = amipAndERA5CC_glbTS(MMEType, ERAType)
    ...
    ccNum=1;
    for exmNum = 4:5
        ERAPath = fullfile('/data2/liuyincheng/Observe-process', tLin.time{exmNum}, ERAType);
    ...
    figTitle.subTitle = {[ERAType, ' 2000-2014'], [ERAType, ' 1980-2014'], ['AMIP 2000-2014'],['AMIP 1980-2014']};
    ...
    figName = [MMEType,'_glbTS_cc_amipAndERA5']; %num2str(plotType),'Plot'
