...
function [mlabels, areaNum] = cmipParameters(p_1, p_2, p_3)
    ...
    if mean(p_1 == 2) == 1 || strcmp(p_1, 'TOA') == 1 || strcmp(p_1, 'toa') == 1
        ...
        if strcmp(p_3, 'radEffect') == 1
            p_1 = 2;
            %% specific labels
            mlabels.unite = {' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $', ...
                ' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $', ...
                ' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $', ...
                ' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $'};
        ...
        elseif strcmp(p_3, 'nonLocalCld_Ts') == 1
            p_1 = 2;
            %% specific labels
            mlabels.unite = {' (K/10a)', ' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $', ...
                ' (K/10a)', ' (K/10a)', ' (K/10a)', ...
                ' (K/10a)', ' (K/10a)', ' (K/10a)', ...
                ' (K/10a)', ' (K/10a)', ' (K/10a)'};
    ...
    elseif mean(p_1 == 1) == 1 || strcmp(p_1, 'SFC') == 1 || strcmp(p_1, 'sfc') == 1
        ...
        elseif strcmp(p_3, 'nonLocalCld2') == 1
            p_1 = 1;
            %% specific labels
            mlabels.unite = {' (K/10a)', ' $\left( W\cdot m^{-2}/10a \right) $', ' (K/10a)', ...
                ' (K/10a)', ' (K/10a)', ' (K/10a)', ...
                ' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $', ' $\left( W\cdot m^{-2}/10a \right) $', ...
                ' (K/10a)', ' (K/10a)', ' (K/10a)'};
