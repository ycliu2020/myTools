...
username_str = "dz1928004" # 你的校园网登陆用户名
password_str = "liuyincheng2019" # 你的校园网登陆密码
...
def login():
    try:
        ...
        driver.get("http://p.nju.edu.cn") # 你的校园网登陆地址
        time.sleep(3)
        ...
        login_button = driver.find_element_by_id("loginBtn") # 校园网登陆连接的点击控件ID, 浏览器上右键查看网页源代码查询
