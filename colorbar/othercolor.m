...
types = who('-file','G:\360data\重要数据\我的文档\MATLAB\tools\mytools\colorbar\othercolor\colorData.mat');
...
if nargin < 1,
    ...
    % load color data
    data = load('G:\360data\重要数据\我的文档\MATLAB\tools\mytools\colorbar\othercolor\colorData.mat',n);
